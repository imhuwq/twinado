...
"""
twinado server.tests.unit.application.login

~~~~~~

twinado server application 功能单元测试模块的登录功能测试
...
class LoginTest(ServerTestBase):
    ...
    def test_01_login_is_okay(self):
        login_url = self.reverse_url('test.user.UserLogin')
    ...
    def test_02_login_state_is_okay(self):
        ...
        profile_url = self.reverse_url('test.user.UserProfile')
    ...
    def test_03_logout_is_okay(self):
        ...
        logout_url = self.reverse_url('test.user.UserLogout')
